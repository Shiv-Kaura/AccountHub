  ...
  return (
    <div className="p-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-[#f2f2f4]">Accounts / Facility Groups</h1>
      ...
      <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {(accounts ?? []).map((a) => (
          <Link
            key={a.id}
            href={`/accounts/${a.id}`}
            className="rounded-lg border border-white/[0.07] p-4 transition hover:border-white/[0.16] hover:shadow-sm"
          >
            <div className="flex items-start justify-between">
              <div>
